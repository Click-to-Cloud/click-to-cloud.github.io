...
var TZono = function (_Component) {
  _inherits(TZono, _Component);

  function TZono() {
    _classCallCheck(this, TZono);

    return _possibleConstructorReturn(this, (TZono.__proto__ || Object.getPrototypeOf(TZono)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TZono, _indexSoy2.default);

exports.default = TZono;
...
exports.templates = exports.TZono = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TZono.
   * @public
   */

  goog.module('TZono.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TZono.render';
  }
...
_metalSoy2.default.register(TZono, templates);
exports.TZono = TZono;
