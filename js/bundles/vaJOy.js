...
var vaJOy = function (_Component) {
  _inherits(vaJOy, _Component);

  function vaJOy() {
    _classCallCheck(this, vaJOy);

    return _possibleConstructorReturn(this, (vaJOy.__proto__ || Object.getPrototypeOf(vaJOy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vaJOy, _indexSoy2.default);

exports.default = vaJOy;
...
exports.templates = exports.vaJOy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vaJOy.
   * @public
   */

  goog.module('vaJOy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vaJOy.render';
  }
...
_metalSoy2.default.register(vaJOy, templates);
exports.vaJOy = vaJOy;
