...
var bMNZX = function (_Component) {
  _inherits(bMNZX, _Component);

  function bMNZX() {
    _classCallCheck(this, bMNZX);

    return _possibleConstructorReturn(this, (bMNZX.__proto__ || Object.getPrototypeOf(bMNZX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bMNZX, _indexSoy2.default);

exports.default = bMNZX;
...
exports.templates = exports.bMNZX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bMNZX.
   * @public
   */

  goog.module('bMNZX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bMNZX.render';
  }
...
_metalSoy2.default.register(bMNZX, templates);
exports.bMNZX = bMNZX;
