...
var BFMja = function (_Component) {
  _inherits(BFMja, _Component);

  function BFMja() {
    _classCallCheck(this, BFMja);

    return _possibleConstructorReturn(this, (BFMja.__proto__ || Object.getPrototypeOf(BFMja)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BFMja, _indexSoy2.default);

exports.default = BFMja;
...
exports.templates = exports.BFMja = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BFMja.
   * @public
   */

  goog.module('BFMja.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BFMja.render';
  }
...
_metalSoy2.default.register(BFMja, templates);
exports.BFMja = BFMja;
