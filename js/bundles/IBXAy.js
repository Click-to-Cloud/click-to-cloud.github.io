...
var IBXAy = function (_Component) {
  _inherits(IBXAy, _Component);

  function IBXAy() {
    _classCallCheck(this, IBXAy);

    return _possibleConstructorReturn(this, (IBXAy.__proto__ || Object.getPrototypeOf(IBXAy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IBXAy, _indexSoy2.default);

exports.default = IBXAy;
...
exports.templates = exports.IBXAy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IBXAy.
   * @public
   */

  goog.module('IBXAy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IBXAy.render';
  }
...
_metalSoy2.default.register(IBXAy, templates);
exports.IBXAy = IBXAy;
