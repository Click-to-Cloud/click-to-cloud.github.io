...
var qfMBv = function (_Component) {
  _inherits(qfMBv, _Component);

  function qfMBv() {
    _classCallCheck(this, qfMBv);

    return _possibleConstructorReturn(this, (qfMBv.__proto__ || Object.getPrototypeOf(qfMBv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qfMBv, _indexSoy2.default);

exports.default = qfMBv;
...
exports.templates = exports.qfMBv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qfMBv.
   * @public
   */

  goog.module('qfMBv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qfMBv.render';
  }
...
_metalSoy2.default.register(qfMBv, templates);
exports.qfMBv = qfMBv;
