...
var NzBaE = function (_Component) {
  _inherits(NzBaE, _Component);

  function NzBaE() {
    _classCallCheck(this, NzBaE);

    return _possibleConstructorReturn(this, (NzBaE.__proto__ || Object.getPrototypeOf(NzBaE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NzBaE, _indexSoy2.default);

exports.default = NzBaE;
...
exports.templates = exports.NzBaE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NzBaE.
   * @public
   */

  goog.module('NzBaE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NzBaE.render';
  }
...
_metalSoy2.default.register(NzBaE, templates);
exports.NzBaE = NzBaE;
