...
var meGzU = function (_Component) {
  _inherits(meGzU, _Component);

  function meGzU() {
    _classCallCheck(this, meGzU);

    return _possibleConstructorReturn(this, (meGzU.__proto__ || Object.getPrototypeOf(meGzU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(meGzU, _indexSoy2.default);

exports.default = meGzU;
...
exports.templates = exports.meGzU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace meGzU.
   * @public
   */

  goog.module('meGzU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'meGzU.render';
  }
...
_metalSoy2.default.register(meGzU, templates);
exports.meGzU = meGzU;
