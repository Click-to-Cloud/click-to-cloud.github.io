...
var fbjqs = function (_Component) {
  _inherits(fbjqs, _Component);

  function fbjqs() {
    _classCallCheck(this, fbjqs);

    return _possibleConstructorReturn(this, (fbjqs.__proto__ || Object.getPrototypeOf(fbjqs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fbjqs, _indexSoy2.default);

exports.default = fbjqs;
...
exports.templates = exports.fbjqs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fbjqs.
   * @public
   */

  goog.module('fbjqs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fbjqs.render';
  }
...
_metalSoy2.default.register(fbjqs, templates);
exports.fbjqs = fbjqs;
