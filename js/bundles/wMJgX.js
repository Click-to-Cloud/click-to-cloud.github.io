...
var wMJgX = function (_Component) {
  _inherits(wMJgX, _Component);

  function wMJgX() {
    _classCallCheck(this, wMJgX);

    return _possibleConstructorReturn(this, (wMJgX.__proto__ || Object.getPrototypeOf(wMJgX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wMJgX, _indexSoy2.default);

exports.default = wMJgX;
...
exports.templates = exports.wMJgX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wMJgX.
   * @public
   */

  goog.module('wMJgX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wMJgX.render';
  }
...
_metalSoy2.default.register(wMJgX, templates);
exports.wMJgX = wMJgX;
