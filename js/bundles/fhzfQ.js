...
var fhzfQ = function (_Component) {
  _inherits(fhzfQ, _Component);

  function fhzfQ() {
    _classCallCheck(this, fhzfQ);

    return _possibleConstructorReturn(this, (fhzfQ.__proto__ || Object.getPrototypeOf(fhzfQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fhzfQ, _indexSoy2.default);

exports.default = fhzfQ;
...
exports.templates = exports.fhzfQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fhzfQ.
   * @public
   */

  goog.module('fhzfQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fhzfQ.render';
  }
...
_metalSoy2.default.register(fhzfQ, templates);
exports.fhzfQ = fhzfQ;
