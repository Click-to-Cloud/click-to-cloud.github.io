...
var YdRkZ = function (_Component) {
  _inherits(YdRkZ, _Component);

  function YdRkZ() {
    _classCallCheck(this, YdRkZ);

    return _possibleConstructorReturn(this, (YdRkZ.__proto__ || Object.getPrototypeOf(YdRkZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YdRkZ, _indexSoy2.default);

exports.default = YdRkZ;
...
exports.templates = exports.YdRkZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YdRkZ.
   * @public
   */

  goog.module('YdRkZ.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param258 = function param258() {
      ...
      ie_close('td');
      ie_open('td');
      ie_open('a', null, null, 'href', 'https://click-to-cloud.github.io/job-apex/');
      itext('Docs');
      ie_close('a');
      ie_close('td');
      ie_close('tr');
      ...
      ie_close('td');
      ie_open('td');
      ie_open('a', null, null, 'href', 'https://click-to-cloud.github.io/t-apex/');
      itext('Docs');
      ie_close('a');
      ie_close('td');
      ie_close('tr');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YdRkZ.render';
  }
...
_metalSoy2.default.register(YdRkZ, templates);
exports.YdRkZ = YdRkZ;
