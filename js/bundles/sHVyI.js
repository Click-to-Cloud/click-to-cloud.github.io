...
var sHVyI = function (_Component) {
  _inherits(sHVyI, _Component);

  function sHVyI() {
    _classCallCheck(this, sHVyI);

    return _possibleConstructorReturn(this, (sHVyI.__proto__ || Object.getPrototypeOf(sHVyI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sHVyI, _indexSoy2.default);

exports.default = sHVyI;
...
exports.templates = exports.sHVyI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sHVyI.
   * @public
   */

  goog.module('sHVyI.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param258 = function param258() {
      ...
      ie_close('td');
      ie_open('td');
      ie_open('a', null, null, 'href', '/', 'onclick', 'location.assign(\'/mobject-apex\')');
      itext('Docs');
      ie_close('a');
      ie_close('td');
      ie_close('tr');
      ...
      ie_close('td');
      ie_open('td');
      ie_open('a', null, null, 'href', '/', 'onclick', 'location.assign(\'/g-apex\')');
      itext('Docs');
      ie_close('a');
      ie_close('td');
      ie_close('tr');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sHVyI.render';
  }
...
_metalSoy2.default.register(sHVyI, templates);
exports.sHVyI = sHVyI;
